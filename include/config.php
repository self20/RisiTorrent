...
$INSTALLER09['cookie_domain'] = 'localhost'; // set to eg: .somedomain.com or is subdomain set to: .sub.somedomain.com
$INSTALLER09['domain'] = 'localhost';
//== Memcache expires
...
//== XBT or PHP announce
if (XBT_TRACKER == true) {
$INSTALLER09['xbt_prefix'] = 'localhost:2710/';  
$INSTALLER09['xbt_suffix'] = '/announce';
$INSTALLER09['announce_urls'][] = 'localhost:2710/announce';
} else {
$INSTALLER09['announce_urls'] = array();
$INSTALLER09['announce_urls'][] = 'localhost';
$INSTALLER09['announce_urls'][] = 'localhost';
}
...
$INSTALLER09['site_email'] = 'wura@protonmail.com';
$INSTALLER09['site_name'] = "RisiTorrent";
