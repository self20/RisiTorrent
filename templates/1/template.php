	      ...
	      <div class='navbor-item has-dropdown is-hoverable'>
              ...
              <a class='navbor-item' href='" . $INSTALLER09['baseurl'] . "/sitepot.php'>{$lang['gl_sitepot']}</a>
				...
				<div class='navbor-item has-dropdown is-hoverable'>
					  ...
					  <a class='navbor-link is-active'>{$lang['gl_torrent']}</a>
